(function() {
  ...
  */
  ...
  var fernando = new Person('Fernando', 'Saraiva', 33);
  var joao = new Person('João', 'Saraiva', 50);
  var mari = new Person('Mari', 'Petry', 50);
  ...
  */
  ...
  console.log(mari.getFullName() + ' tem ' + mari.getAge() + ' anos.');
  ...
  */
  ...
  console.log(mari.getFullName() + ' agora tem ' + mari.addAge(5).getAge() + ' anos.');
})();